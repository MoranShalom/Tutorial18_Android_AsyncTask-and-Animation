package com.example.asynctaskandanimatio6;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // !!! this line : currentBackgroundColor = ((ColorDrawable)background.getBackground()).getColor();
        //returned this error:Caused by: java.lang.NullPointerException: Attempt to invoke virtual method 'int android.graphics.drawable.ColorDrawable.getColor()' on a null object reference
        // so i changed to this code line instead

        //get current view's background color
        currentBackgroundColor = ContextCompat.getColor(this ,R.color.colorAccent);
